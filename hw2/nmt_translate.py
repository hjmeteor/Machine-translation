...
Add a hook function to optimizer object. This optimizer will use this object to minimize the loss later.
It setting the gradient, wich is bigger than and equals to 5 to prevent gradient exploration.
'''
